...
function BonusChallenge({numBonusHouses, checkBonusAnswer, setConfetti, totalDays}) {
  ...
  return (
    <>
      <Fade in={bonusSubmitted && bonusCorrect} mountOnEnter unmountOnExit timeout={theme.transitions.duration.standardTextFade}>
        <p> 
      ...
      {!bonusSubmitted &&
        <>
          <p>
            ...
            <br /><i>Spectacular, you have caught my rat in only {totalDays} days. That is the optimal solution! 
