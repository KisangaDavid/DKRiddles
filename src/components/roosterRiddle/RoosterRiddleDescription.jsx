  ...
  // <Fade in={true} mountOnEnter unmountOnExit timeout={theme.transitions.duration.standardTextFade}>
    <Box sx={{width: "75vw", position: "relative", mb:"3vh"}}>
      <p>
        ...
        As soon as you finish reading the note, a magestic rooster struts over and drops a small linnen bag at your feet. The bag, seemingly with a mind of its own, tips over and spills the corn kernels inside into four neat piles.
      </p>
    </Box>
  // </Fade>
);
