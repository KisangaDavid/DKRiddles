...
extern "C" {
     __declspec(dllexport) uint32_t getInitialPiles(uint32_t randSource) {
...
extern "C" {
     __declspec(dllexport) uint32_t getRoosterRiddleMove(uint32_t inputPiles, uint32_t randSource) {
