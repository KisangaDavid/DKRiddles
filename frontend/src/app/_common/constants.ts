...
export const HORSE_PUZZLE = "HORSE_P1";
export const ROOSTER_PUZZLE = "ROOSTER_P1";
export const RABBIT_PUZZLE_P1 = "RABBIT_P1";
export const RABBIT_PUZZLE_P2 = "RABBIT_P2";

export const RAT_PUZZLE_P1_TITLE = "The Sneaky Rat (Part 1)";
export const RAT_PUZZLE_P2_TITLE = "The Sneaky Rat (Part 2)";
export const HORSE_PUZZLE_TITLE = "The Horse Trifecta";
export const ROOSTER_PUZZLE_TITLE = "The Undefeated Rooster";
export const RABBIT_PUZZLE_P1_TITLE = "Jumping Rabbits (Part 1)";
