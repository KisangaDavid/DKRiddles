...
class PuzzleNames(models.TextChoices):
    RAT_PUZZLE_P1     = "RAT_PUZZLE_P1",     "Rat Puzzle Part 1"
    RAT_PUZZLE_P2     = "RAT_PUZZLE_P2",     "Rat Puzzle Part 2"
    HORSE_PUZZLE_P1   = "HORSE_PUZZLE_P1",   "Horse Puzzle"
    ROOSTER_PUZZLE_P1 = "ROOSTER_PUZZLE_P1", "Rooster Puzzle"
    RABBIT_PUZZLE_P1  = "RABBIT_PUZZLE_P1",  "Rabbit Puzzle Part 1"
    RABBIT_PUZZLE_P2  = "RABBIT_PUZZLE_P2",  "Rabbit Puzzle Part 2"
